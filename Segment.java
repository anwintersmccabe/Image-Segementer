...
public class Segment {
    ...
    public static void main(String[] args) throws IOException {
      ...
      //  Color [][] rgbArray = {{Color.black, Color.cyan, Color.red, Color.yellow}, {Color.green, Color.orange, 
        		//Color.magenta, Color.red}, {Color.red, Color.white, Color.yellow, Color.blue}, {Color.yellow, Color.orange, Color.red, Color.magenta}};
        
        // Segment and write output
       writeImageRaster(outputFile,  ImageSegmenter.segment(rgbArray, granularity));
       // Color [][] nArray = ImageSegmenter.segment(rgbArray, granularity);
      //  for(int i=0; i<nArray.length; i++) {
        //	for(int j=0; j<nArray[0].length; j++) {
        		//System.out.println(i+","+j+" "+nArray[i][j]);
        	//}
        //}
    }
